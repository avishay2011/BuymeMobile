...
public class BaseTest {
    ...
    public void uploadApp() throws MalformedURLException {
        ...
        registrationPage_step2_insertCode=new RegistrationPage_Step2_InsertCode(driver);
        registrationPage_form=new RegistrationPage_Form(driver);
    ...
    public void openChromeAndSwitchToWebView() {
        try {
            ...
            // 2. חכה כמה שניות כדי שכרום יטען
            Thread.sleep(5000);

            // 3. קבל את כל ה-contextים הזמינים
