...
public class Coupon_Page extends BasePage {
    ...
    //Elements
    private By giftCard_Name = By.id(".supplier-page__details h1");
    private By amount_Field = By.id("undefined-cardPrice");
    private By select_Button = By.id("//button[text()='בחירה']");
    private By errorMessage_NoAmountEntered = By.id(".text-field__error-message");
