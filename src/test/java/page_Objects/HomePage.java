...
public class HomePage extends BasePage {
 ...
 //   private By searchButton=By.id("search_icon"); ///Unique element .also used for verify that the right page opened
    private By myAccount_Link=By.id("profile_pic");
//    private By myAccount_Details=By.id("//span[text()='פרטי חשבון']");
 //   private By amounts_Dropdown_Button=By.id("div>span[alt=\"סכום\"]"); ///This location is visible only while amount field is clear,so it's also good for check the clear button
 //   private By regions_Dropdown_Button=By.id("div>span[alt=\"אזור\"]");/// This location is visible only while region field is clear,so it's also good for check the clear button
//    private By categories_Dropdown_Button=By.id("div>span[alt=\"קטגוריה\"]");/// This location is visible only while category field is clear,so it's also good for check the clear button
 //   private By dropDownList_Values=By.id(".show-options>select>option"); ///all dropdown are on the same location and it's works properly because just one dropdown can be opened at the same time
    private By searchButton=By.id("search_icon");
    private By clearSearch_Button=By.id("search_close_btn");
  //  private By logOut_Button=By.id("//span[text()='יציאה']");
  //  private By closePopUp_Button=By.id("button[aria-label=\"close\"]");
    private By birthDayGifts_Link=By.id("a[title=\"מתנות ליום הולדת\"]");
    private By checkGiftCardBalance_Button=By.id("//a[text()='בדיקת יתרה בGift Card']");
    private By giftsForEmployees_Button=By.id("מתנות לעובדים");
  //  private By closePopUpButton2=By.id("button[aria-label=\"כפתור סגירה\"]");
